        ...
        <div className="relative top-0 bg-white">
          <div className="flex justify-between px-4 pt-4 pb-2">
            ...
            <div className="flex justify-between">
              <Link href="https://www.instagram.com/tillmann_severin/">
                <FaInstagram className="text-lg pl-1" />
              </Link>
              <Link href="https://de.linkedin.com/in/tillmann-severin">
                <LiaLinkedin className="text-lg pl-1" />
              </Link>
              <Link href="https://github.com/TS-Severin">
                <FaGithub className="text-lg pl-1" />
              </Link>
